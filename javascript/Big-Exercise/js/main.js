...
function moneyPay () {
    ...
    console.log(radioCar, radioSUV, radioBlack)
    var soKM = document.getElementById('inputKM').value;
    var soTG = document.getElementById('inputTG').value;
    console.log(soKM, soTG)

    var typeCar =checkTypeCar(radioCar,radioSUV,radioBlack)
    console.log(typeCar)
}


function checkTypeCar(radioCar, radioSUV, radioBlack){
    var typeCar = "";
    if(radioCar.checked){
        typeCar = "car";
    }else if(radioSUV.checked){
        ...
        alert = "Plz checked cartype"
    }
    return typeCar;
}

document.getElementById('btnmoneyPay').onclick=moneyPay